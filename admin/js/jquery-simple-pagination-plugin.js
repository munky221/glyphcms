(function($){
	$.fn.simplePagination = function(perPage, opened, onClass, paginationSelector){
		...
		var to_append = '<ul class="pagination"><li class="prev"><a href="#"><span>previous</span></a></li>';
		// var to_append = '';
		for (i = 1; i <= no_pages; i++) {
			to_append += '<li class="pagination-page-numbers';
			if (i === opened) {
				to_append += ' '+onClass;
			}
			to_append += '"><a href="#"><span>'+i+'</span></a></li>';
		}
		to_append += '<li class="next"><a href="#"><span>next</span></a></li></ul>';
		// to_append += '';
		if (opened !== 1) {
			if (opened === no_pages) {

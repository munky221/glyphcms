...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Updating Gallery Status</h4>
		</div>

		<form class="form" name="form-create-category" id="slideshowUpdateStatusForm" role="form" action="gallery-update-action.php" method="post" enctype="multipart/form-data" target="_self">

...
// define("DB_NAME", "photopress_maindb");
...
define("COOKIE_SECRET_KEY", "d89b864cfc90fb95c524655e243d85ec");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", $site->url . "admin/password-reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@" . $site->domain);
define("EMAIL_PASSWORDRESET_FROM_NAME", $site->system_name);
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for " . $site->system_name);
 ...
 */
define("EMAIL_VERIFICATION_URL", $site->url . "admin/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@" . $site->domain);
define("EMAIL_VERIFICATION_FROM_NAME", $site->system_name);
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for " . $site->system_name);

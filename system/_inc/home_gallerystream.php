            <!-- GALLERY PRESENTATION TEMPLATE - HOME -->
            <div class="container-fluid">
                <div id="carousel">
                    ...
                    <div id="carousel-filmstrip">
                        <ul>
                            <% _.each(homepage, function(th_slide) { %>
                    ...
                    function Carousel(element)
                    {
                        ...
                        this.showPane = function(index, animate) {
                            ...
                            if (current_pane == t_slide_total+1) {
                                ...
                                // load next slideshow
                                if (t_slide_num < homepageDump.length-1) {
                                    t_slide_num++;
                                    t_slide_id = homepageDump[t_slide_num]['slide_id'];
                                    current_pane = 1;
                                } else {
                                    t_slide_num = 0;
                                    t_slide_id = homepageDump[t_slide_num]['slide_id'];
                                ...
                                if (t_slide_num > 0) {
                                    ...
                                    t_slide_num = homepageDump.length-1;
                                }
                                t_slide_id = homepageDump[t_slide_num]['slide_id'];
                                current_pane = homepageDump[t_slide_num]['photo_count'];
                                var newUrl = "#/gallery/<%= gid %>/" + t_slide_id + "/" + current_pane;
                                console.log(newUrl);
                                window.location.hash = newUrl;
                            } else {
